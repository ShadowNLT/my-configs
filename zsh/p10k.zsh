# Generated by Powerlevel10k configuration wizard on 2025-11-21 at 21:04 CET.
...
typeset -g POWERLEVEL9K_DISABLE_BOLD=true
# --- TokyoNight Moon Prompt Colors ---
# Soft foreground and dark background
typeset -g POWERLEVEL9K_BACKGROUND='#1e2030'
...
# Accent colors for symbols and git
typeset -g POWERLEVEL9K_ICON_FOREGROUND='#7dcfff'
typeset -g POWERLEVEL9K_VCS_MODIFIED_FOREGROUND='#e0af68'
typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND='#9ece6a'
# TokyoNight directory segment
typeset -g POWERLEVEL9K_DIR_FOREGROUND='#7aa2f7'   # soft tokyonight blue
typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND='#bb9af7'  # softer purple
