...
description: >
  ...
  Trigger on: "/write-tests", "write tests", "review these tests", "is this
  tested enough", "add unit tests", "this test is flaky", "too many e2e tests",
  "should I mock this", "test pyramid", "hourglass tests", "how should I test
  this", writing or reviewing test files.
---

# Write Tests

Target: the tests (or missing tests) in play — a file, a diff, a feature being implemented, or
