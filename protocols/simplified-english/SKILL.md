...
description: >
  ...
  Trigger on: "simplified-english", "STE", "ASD-STE100", "Simplified Technical
  English", "unambiguous procedure", "tighten this runbook", "instruction-safe
  English", "de-slop this error", "STE strict", "STE compliance" — not bare
  "plain English" or layman-terms jargon asks (those belong to layman-terms; ask
  on dual cues or bare "simplified English").
---
...
Infer the target from context (pasted prose, the message under discussion, or
the most recent technical paragraph). If ambiguous, ask rather than guess.
