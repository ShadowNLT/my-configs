...
argument-hint: [topic, behavior, or paste to rewrite into an Algo Sketch]
---
...
Target: `$ARGUMENTS` — or, if empty:

1. the most recent algorithm / design / code explanation in the conversation, else
2. ask what to present — do not invent a domain.
