...
Trigger phrases (from upstream): "make me an atlas of this pipeline" "map the system so we can talk about it" "I want a diagram I can click around and poke holes in" "walk me through how this fits together" "update the atlas — we dropped the nightly job and picked a different vendor"
